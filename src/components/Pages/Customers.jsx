...
const Customers = () => {
  ...
  return (
    ...
    <div>
        <Nav/>
        <div className='flex'>
            <h5 className="col-10 fw-normal text-secondary fb">Home / Customers List</h5>
            <ButtonB className="col-2 btn btn-primary border-0"><AddIcon/> Customer</ButtonB>
        </div>
                    ...
                    <table className="table table-striped">
                        <thead className="bg-soft text-light">
                            <tr>
                                ...
                                <th scope="col" className="p-3 text-center bod-li">Company Name</th>
                                <th scope="col" className="p-3 text-center bod-li">Email</th>
                                <th scope="col" className="p-3 text-center bod-li">Contact Person</th>
                                <th scope="col" className="p-3 text-center bod-li">Contact Phone</th>
