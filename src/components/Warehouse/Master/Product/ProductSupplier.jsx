...
const ProductSupplier = (props) => { 
  ...
  <div>
    ...
    <Dialog open={props.open} onClose={props.close}>
      <DialogTitle className='text-center'><Title>Primary Supplie Dialogr</Title></DialogTitle>
      <DialogContent>
        <Form>
          <form>
     ...
     : ''}
      ...
      <DialogActions>
        <Button onClick={props.close} style={{backgroundColor: '#79a6fa', color: 'white'}}>Cancel</Button>
